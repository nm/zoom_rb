  ...
  module Actions
    module Webinar
      ...
      SETTINGS_KEYS = %i[host_video panelists_video practice_session hd_video approval_type
                         ...
                         show_share_button allow_multiple_devices on_demand global_dial_in_countries 
                         contact_name contact_email registrants_confirmation_email registrants_restrict_number
                         notify_registrants post_webinar_survey survey_url registrants_email_notification 
                         meeting_authentication authentication_options authentication_domains].freeze
